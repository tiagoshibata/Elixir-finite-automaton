defmodule FiniteAutomationTest do
  ...
  test "tests sentence acceptance" do
    assert FiniteAutomation.accepts_sentence?(:q0, [], @nondeterministic_with_empty_loop, [:q0])
    assert not FiniteAutomation.accepts_sentence?(:q0, [], @nondeterministic_with_empty_loop, [:q1, :q2, :q3, :q4, :q5])
